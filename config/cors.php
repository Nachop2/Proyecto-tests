...
return [
    ...
    */
    ...
    'allowed_headers' => ['Content-Type', 'X-Requested-With', 'Origin', 'Authorization', 'Accept', 'Client-Security-Token', 'Accept-Encoding', 'X-Auth-Token', 'X-XSRF-TOKEN', 'X-CSRF-Token'],
